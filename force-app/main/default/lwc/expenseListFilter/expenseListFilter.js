...
export default class ExpenseListFilter extends LightningElement {
  ...
  connectedCallback() {
    try {
      ...
      alert("connectedCallback=" + err.message);
    }
  }
  ...
  handleRecordsPerPage(event) {
    try {
      ...
      alert("handleRecordsPerPage=" + err.message);
    }
  }
  handlePageNumberChange(event) {
    try {
      ...
      alert("handlePageNumberChange=" + err.message);
    }
  }
  previousPage() {
    try {
      ...
      alert("previousPage=" + err.message);
    }
  }
  nextPage() {
    this.pageNumber = this.pageNumber + 1;
  ...
  setRecordsToDisplay() {
    try {
      ...
      alert("setRecordsToDisplay=" + err.message);
    }
  }
  setPaginationControls() {
    try {
      ...
      alert("setPaginationControls=" + err.message);
    }
  }
